...
def report():
    ...
    while not_valid:
        ...
        print("1  Annual Expense Category or Name amount paid for inputted range of years Report.")
    ...
    # A text or csv report for expenses in for an expense type or category for a year range {year 1 to year 2} or a
        ...
        # ask user if want csv or text report
        # check validity
        # ask user what field do you want to find annual yearly data for
        # check validity
        # ask user what the range of years for the report will be
        # check validity if data for those years exist
        # somehow use search and modify func to find all data for a field in a year and repeat w/ other years
